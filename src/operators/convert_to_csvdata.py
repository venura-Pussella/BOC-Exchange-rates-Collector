...
def write_exchange_rates_to_csv_data(exchange_rates_df):
    ...
    writer.writerow([
        ...
        "Travelers Cheques/Drafts_Buying_Rate", 
        "Travelers Cheques/Drafts_Selling_Rate",
        "Telegraphic/PFCA/BFCA Transfers_Buying_Rate",
        "Telegraphic/PFCA/BFCA Transfers_Selling_Rate",
        "Bank", 
        "Date", 
        "Time", 
        "ST BANK CODE",
